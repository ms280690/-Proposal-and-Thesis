...
data UnpackedFlatItem = UOp {
   ...
   deriving Show
{--
:t UOp (Atom "hello") (Just ((Ofx,500) :: PrologPrio)) (Just ((Ofy,200) :: PrologPrio))
UOp (Atom "hello") (Just ((Ofx,500) :: PrologPrio)) (Just ((Ofy,200) :: PrologPrio))
  :: Maybe PrologPrio -> UnpackedFlatItem
...
{--
unpack defaultDict (FITerm (Struct (Atom "hello") []))
UTerm hello
--}
...
unflatten _ x           = x
{--
unflatten defaultDict (Flat [FITerm (Struct (Atom "hello") [(Var $ VariableName 0 "X"), (Var $ VariableName 1 "Y"), 
(Struct (Atom "world") [])])])
hello(X,Y#1,world)
--}
